    ...
    const handleSubmit = async (
        ...
        try {
            const response = await axios.post(
                "https://v8.api.sinusoid.in/sponsorContact",
                values
            );
            setSubmitted(true);
        } catch (error) {
        ...
        <div className="flex flex-col-reverse md:flex-col lg:flex-row items-center justify-between w-full p-8 lg:p-16">
            ...
            <div className="lg:w-1/2 w-full lg:mr-16">
                ...
                <p className="text-xl lg:text-2xl my-8 md:mt-8">
                    Partnering with us puts your brand before a dynamic audience
                    of future leaders, offering a unique chance to connect,
                    inspire, and make a lasting impact.
                    <br />
                    <br />
                    PARTNER WITH US TO SHAPE THE FUTURE AND DRIVE POSITIVE
                    CHANGE.
                </p>
