        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const attendeeResponse = await fetch(
                    `https://v8.api.sinusoid.in/attendee/${attendeeId}`
                );
                ...
                const idCardResponse = await fetch(
                    `https://v8.api.sinusoid.in/idCard/${attendeeId}`
                );
                            ...
                            <div className="flex flex-col items-center md:items-start gap-6 text-center md:text-left">
                                <div className="flex flex-col sm:flex-row items-center gap-5">
                                    ...
                                    <h2 className="text-3xl sm:text-4xl font-extrabold">
                                        Your VIP Pass to the Ultimate Event
                                        Experience
                                    </h2>
                                </div>
                            ...
                            >
                                ...
                                <ul className="space-y-5">
                                    ...
                                    <li className="flex items-center">
                                        ...
                                        {cardImage && (
                                            <ShareButton imageUrl={cardImage} />
                                        )}
                                    </li>
                                </ul>
                            </div>
